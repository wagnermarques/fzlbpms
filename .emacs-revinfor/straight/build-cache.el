...
#s(hash-table test equal data ("straight" ("2026-09-11 16:08:54" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "main" :package "straight" :local-repo "straight.el")) "org-elpa" ("2026-08-28 10:28:43" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2026-08-28 10:28:50" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2026-08-28 10:28:51" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "use-package" ("2026-08-28 10:28:55" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2026-08-28 10:28:55" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "modus-themes" ("2026-08-28 10:29:03" ("emacs") (:type git :host github :repo "protesilaos/modus-themes" :package "modus-themes" :local-repo "modus-themes")) "vertico" ("2026-08-28 10:29:07" ("emacs" "compat") (:type git :files (:defaults "extensions/vertico-*.el" "vertico-pkg.el") :host github :repo "minad/vertico" :package "vertico" :local-repo "vertico")) "compat" ("2026-08-28 10:29:07" ("emacs") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "orderless" ("2026-08-28 10:29:10" ("emacs" "compat") (:type git :host github :repo "oantolin/orderless" :package "orderless" :local-repo "orderless")) "marginalia" ("2026-08-28 10:29:12" ("emacs" "compat") (:type git :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "corfu" ("2026-08-28 10:29:14" ("emacs" "compat") (:type git :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu" :package "corfu" :local-repo "corfu")) "cape" ("2026-08-28 10:29:16" ("emacs" "compat") (:type git :host github :repo "minad/cape" :package "cape" :local-repo "cape")) "auctex" ("2026-08-28 10:29:21" ("emacs") (:type git :host github :repo "emacs-straight/auctex" :files ("*" (:exclude ".git")) :package "auctex" :local-repo "auctex")) "pdf-tools" ("2026-08-28 10:29:27" ("emacs" "tablist" "let-alist") (:type git :files (:defaults "README" ("build" "Makefile") ("build" "server") "pdf-tools-pkg.el") :host github :repo "vedang/pdf-tools" :package "pdf-tools" :local-repo "pdf-tools")) "tablist" ("2026-08-28 10:29:25" ("emacs") (:type git :host github :repo "emacsorphanage/tablist" :package "tablist" :local-repo "tablist")) "let-alist" ("2026-08-28 10:29:27" ("emacs") (:type git :host github :repo "emacs-straight/let-alist" :files ("*" (:exclude ".git")) :package "let-alist" :local-repo "let-alist")) "ebib" ("2026-08-28 10:29:33" ("parsebib" "emacs" "compat") (:type git :host github :repo "joostkremers/ebib" :package "ebib" :local-repo "ebib")) "parsebib" ("2026-08-28 10:29:32" ("emacs") (:type git :host github :repo "joostkremers/parsebib" :package "parsebib" :local-repo "parsebib")) "magit" ("2026-08-28 10:29:53" ("emacs" "compat" "cond-let" "llama" "magit-section" "seq" "transient" "with-editor") (:type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("githooks" "githooks/*") ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "cond-let" ("2026-08-28 10:29:43" ("emacs") (:type git :host github :repo "tarsius/cond-let" :package "cond-let" :local-repo "cond-let")) "llama" ("2026-08-28 10:29:44" ("emacs" "compat") (:type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama" :package "llama" :local-repo "llama")) "magit-section" ("2026-08-28 10:29:46" ("emacs" "compat" "cond-let" "llama" "seq") (:files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "seq" ("2026-08-28 10:29:46" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq")) "transient" ("2026-08-28 10:29:49" ("emacs" "compat" "cond-let" "llama" "seq") (:type git :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2026-08-28 10:29:51" ("emacs" "compat" "cond-let" "llama") (:type git :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "treemacs" ("2026-08-28 10:30:24" ("emacs" "cl-lib" "dash" "s" "ace-window" "pfuture" "hydra" "ht" "cfrs") (:type git :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs" :package "treemacs" :local-repo "treemacs")) "nongnu-elpa" ("2026-08-28 10:29:59" nil (:type git :repo "https://github.com/emacsmirror/nongnu_elpa.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2026-08-28 10:30:02" nil (:type git :host github :repo "dimitri/el-get" :build nil :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2026-08-28 10:30:04" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "dash" ("2026-08-28 10:30:07" ("emacs") (:type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "s" ("2026-08-28 10:30:09" nil (:type git :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "ace-window" ("2026-08-28 10:30:13" ("avy") (:type git :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "avy" ("2026-08-28 10:30:13" ("emacs" "cl-lib") (:type git :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "pfuture" ("2026-08-28 10:30:14" ("emacs") (:type git :host github :repo "Alexander-Miller/pfuture" :package "pfuture" :local-repo "pfuture")) "hydra" ("2026-08-28 10:30:16" ("cl-lib" "lv") (:type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2026-08-28 10:30:16" nil (:files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "ht" ("2026-08-28 10:30:18" ("dash") (:type git :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "cfrs" ("2026-08-28 10:30:22" ("emacs" "dash" "s" "posframe") (:type git :host github :repo "Alexander-Miller/cfrs" :package "cfrs" :local-repo "cfrs")) "posframe" ("2026-08-28 10:30:22" ("emacs") (:type git :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "treemacs-nerd-icons" ("2026-08-28 10:30:30" ("emacs" "nerd-icons" "treemacs") (:type git :host github :repo "rainstormstudio/treemacs-nerd-icons" :package "treemacs-nerd-icons" :local-repo "treemacs-nerd-icons")) "nerd-icons" ("2026-08-28 10:30:30" ("emacs") (:type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el" :package "nerd-icons" :local-repo "nerd-icons.el"))))

#s(hash-table test equal data ("straight" ((straight-ert-print-hack straight straight-x straight-autoloads) (autoload 'straight-remove-unused-repos "straight" "Remove unused repositories from the repos and build directories.
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t) (register-definition-prefixes "bind-key" '("bind-key" "override-global-m")) (provide 'bind-key-autoloads)) "use-package" ((use-package-autoloads use-package-delight use-package-diminish use-package use-package-pkg use-package-bind-key use-package-ensure use-package-core use-package-lint use-package-jump use-package-ensure-system-package) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
with the specified `:load-path' the module cannot be found." t) (register-definition-prefixes "use-package-lint" '("use-package-lint-declaration")) (provide 'use-package-autoloads)) "modus-themes" ((modus-operandi-tinted-theme modus-operandi-theme modus-themes modus-vivendi-tinted-theme modus-operandi-tritanopia-theme modus-themes-autoloads modus-operandi-deuteranopia-theme modus-vivendi-tritanopia-theme modus-vivendi-deuteranopia-theme modus-vivendi-theme) (register-definition-prefixes "modus-operandi-deuteranopia-theme" '("modus-operandi-deuteranopia-palette-")) (register-definition-prefixes "modus-operandi-theme" '("modus-operandi-palette-")) (register-definition-prefixes "modus-operandi-tinted-theme" '("modus-operandi-tinted-palette-")) (register-definition-prefixes "modus-operandi-tritanopia-theme" '("modus-operandi-tritanopia-palette-")) (autoload 'modus-themes-contrast "modus-themes" "Measure WCAG contrast ratio between COLOR-1 and COLOR-2.
Color values are of the form accepted by `modus-themes-wcag-formula'.

(fn COLOR-1 COLOR-2)") (autoload 'modus-themes-activate "modus-themes" "Load THEME if neeeded, so that it can be used by other commands.
...
(fn &optional ARG)" t) (register-definition-prefixes "vertico-buffer" '("vertico-buffer-")) (defvar vertico-directory-tidy t "Tidy shadowed file names.") (custom-autoload 'vertico-directory-tidy "vertico-directory" nil) (autoload 'vertico-directory-enter "vertico-directory" "Enter directory or exit completion with current candidate.
...
(fn &optional ARG)" t) (register-definition-prefixes "vertico-reverse" '("vertico-reverse-")) (autoload 'vertico-sort-history-length-alpha "vertico-sort") (autoload 'vertico-sort-history-alpha "vertico-sort") (autoload 'vertico-sort-length-alpha "vertico-sort") (autoload 'vertico-sort-alpha "vertico-sort") (autoload 'vertico-sort-directories-first "vertico-sort" "Sort directories before files in LIST.
...
(fn &optional ARG)" t) (register-definition-prefixes "vertico-unobtrusive" '("vertico-unobtrusive--restore")) (provide 'vertico-autoloads)) "orderless" ((orderless orderless-kwd orderless-autoloads) (autoload 'orderless-all-completions "orderless" "Split STRING into components and find entries TABLE matching all.
...
(fn &optional ARG)" t) (autoload 'marginalia-cycle "marginalia" "Cycle between annotators in `marginalia-annotators'." t) (function-put 'marginalia-cycle 'completion-predicate #'(lambda (&rest _) (> (minibuffer-depth) 1))) (register-definition-prefixes "marginalia" '("marginalia-")) (provide 'marginalia-autoloads)) "corfu" ((corfu-info corfu-autoloads corfu corfu-echo corfu-mouse corfu-auto corfu-popupinfo corfu-quick corfu-history corfu-indexed) (autoload 'corfu-mode "corfu" "COmpletion in Region FUnction.
...
list.") (custom-autoload 'global-corfu-modes "corfu" t) (register-definition-prefixes "corfu" '("corfu-" "global-corfu-minibuffer")) (register-definition-prefixes "corfu-auto" '("corfu-auto-")) (defvar corfu-echo-mode nil "Non-nil if Corfu-Echo mode is enabled.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `corfu-history-mode'.") (custom-autoload 'corfu-history-mode "corfu-history" nil) (autoload 'corfu-history-mode "corfu-history" "Save completion history and sort candidates by history.
...
(fn &optional ARG)" t) (register-definition-prefixes "corfu-info" '("corfu-info--")) (defvar corfu-mouse-mode nil "Non-nil if Corfu-Mouse mode is enabled.
See the `corfu-mouse-mode' command
for a description of this minor mode.") (custom-autoload 'corfu-mouse-mode "corfu-mouse" nil) (autoload 'corfu-mouse-mode "corfu-mouse" "Mouse support, scrolling and clickable candidates.
...
(fn &optional ARG)" t) (register-definition-prefixes "corfu-mouse" '("corfu-mouse-")) (defvar corfu-popupinfo-mode nil "Non-nil if Corfu-Popupinfo mode is enabled.
See the `corfu-popupinfo-mode' command
for a description of this minor mode.") (custom-autoload 'corfu-popupinfo-mode "corfu-popupinfo" nil) (autoload 'corfu-popupinfo-mode "corfu-popupinfo" "Show candidate documentation in a popup.
...
(fn &rest CAPFS)") (autoload 'cape-wrap-choose "cape" "Call each of CAPFS in turn and return first non-nil result.
...
(fn CAPF)") (autoload 'cape-wrap-properties "cape" "Call CAPF and add completion PROPERTIES.
...
(fn CAPF)") (autoload 'cape-wrap-sort "cape" "Call CAPF and add SORT function as completion metadata.
...
(fn CAPF &optional SORT)") (autoload 'cape-wrap-predicate "cape" "Call CAPF and add an additional candidate PREDICATE.
...
(fn CAPF)") (autoload 'cape-wrap-trigger "cape" "Ensure that TRIGGER character occurs before point and then call CAPF.
...
(fn CAPF TRIGGER)") (autoload 'cape-capf-accept-all "cape") (autoload 'cape-capf-buster "cape") (autoload 'cape-capf-case-fold "cape") (autoload 'cape-capf-choose "cape") (autoload 'cape-capf-debug "cape") (autoload 'cape-capf-inside-code "cape") (autoload 'cape-capf-inside-comment "cape") (autoload 'cape-capf-inside-faces "cape") (autoload 'cape-capf-inside-string "cape") (autoload 'cape-capf-nonexclusive "cape") (autoload 'cape-capf-noninterruptible "cape") (autoload 'cape-capf-passthrough "cape") (autoload 'cape-capf-predicate "cape") (autoload 'cape-capf-prefix-length "cape") (autoload 'cape-capf-properties "cape") (autoload 'cape-capf-silent "cape") (autoload 'cape-capf-sort "cape") (autoload 'cape-capf-super "cape") (autoload 'cape-capf-trigger "cape") (autoload 'cape-prefix-map "cape" nil t 'keymap) (register-definition-prefixes "cape" '("cape-")) (autoload 'cape-tex "cape-char" nil t) (autoload 'cape-sgml "cape-char" nil t) (autoload 'cape-rfc1345 "cape-char" nil t) (autoload 'cape-emoji "cape-char" nil t) (register-definition-prefixes "cape-char" '("cape-char--")) (autoload 'cape-keyword "cape-keyword" "Complete programming language keyword at point.
See the variable `cape-keyword-list'.
If INTERACTIVE is nil the function acts like a capf.

(fn &optional INTERACTIVE)" t) (register-definition-prefixes "cape-keyword" '("cape-")) (provide 'cape-autoloads)) "auctex" ((tex-info tex-ispell context-nl bib-cite auctex-autoloads tex-mik context tex-site preview tex-font tex-jp context-en tex-wizard toolbar-x tex-bar plain-tex auctex-pkg texmathp font-latex tex auctex latex tex-fold latex-flymake multi-prompt tex-style) (register-definition-prefixes "auctex" '("AUCTeX-version")) (autoload 'bib-cite-minor-mode "bib-cite" "Toggle bib-cite mode.
...
(fn BOUND)") (register-definition-prefixes "texmathp" '("texmathp-")) (autoload 'toolbarx-install-toolbar "toolbar-x") (register-definition-prefixes "toolbar-x" '("toolbarx-")) (provide 'auctex-autoloads)) "tablist" ((tablist-filter tablist-autoloads tablist) (autoload 'tablist-minor-mode "tablist" "Toggle tablist minor mode.
...
(fn)" t) (register-definition-prefixes "tablist" '("tab")) (register-definition-prefixes "tablist-filter" '("tablist-filter-")) (provide 'tablist-autoloads)) "let-alist" ((let-alist-autoloads let-alist let-alist-pkg) (autoload 'let-alist "let-alist" "Let-bind dotted symbols to their cdrs in ALIST and execute BODY.
...
(fn ALIST &rest BODY)" nil t) (function-put 'let-alist 'lisp-indent-function 1) (register-definition-prefixes "let-alist" '("let-alist--")) (provide 'let-alist-autoloads)) "pdf-tools" ((pdf-annot pdf-misc pdf-util pdf-tools-autoloads pdf-roll pdf-history pdf-virtual pdf-cache pdf-info pdf-tools pdf-isearch pdf-sync pdf-outline pdf-macs pdf-dev pdf-view pdf-links pdf-occur pdf-loader) (autoload 'pdf-annot-minor-mode "pdf-annot" "Support for PDF Annotations.
...
(fn &optional FILENAMES BUFFER-NAME DISPLAY-P)" t) (register-definition-prefixes "pdf-virtual" '("pdf-virtual-")) (provide 'pdf-tools-autoloads)) "parsebib" ((parsebib parsebib-autoloads) (register-definition-prefixes "parsebib" '("parsebib-")) (provide 'parsebib-autoloads)) "ebib" ((ebib-autoloads ebib ebib-filters ebib-notes ebib-reading-list ebib-ivy ebib-keywords ebib-utils ebib-biblio org-ebib ebib-db) (autoload 'ebib "ebib" "Ebib, a BibTeX database manager.
...
(fn DOI)" t) (register-definition-prefixes "ebib-biblio" '("ebib-biblio-")) (register-definition-prefixes "ebib-db" '("ebib-")) (register-definition-prefixes "ebib-filters" '("ebib-")) (register-definition-prefixes "ebib-keywords" '("ebib-")) (register-definition-prefixes "ebib-notes" '("ebib-")) (register-definition-prefixes "ebib-reading-list" '("ebib-")) (put 'ebib-preload-bib-files 'safe-local-variable '(lambda (val) (seq-every-p #'stringp val))) (register-definition-prefixes "ebib-utils" '("ebib-" "with-")) (autoload 'org-ebib-open "org-ebib" "Open Ebib and jump to ENTRY.

(fn ENTRY)") (register-definition-prefixes "org-ebib" '("org-ebib-")) (provide 'ebib-autoloads)) "cond-let" ((cond-let cond-let-autoloads) (defvar cond-let-fontify-mode nil "Non-nil if Cond-Let-Fontify mode is enabled.
See the `cond-let-fontify-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `cond-let-fontify-mode'.") (custom-autoload 'cond-let-fontify-mode "cond-let" nil) (autoload 'cond-let-fontify-mode "cond-let" "In Emacs Lisp mode, highlight `$' using `font-lock-variable-name-face'.
...
(fn &optional ARG)" t) (register-definition-prefixes "cond-let" '("cond-let")) (provide 'cond-let-autoloads)) "llama" ((llama-autoloads llama \.dir-locals) (autoload 'llama "llama" "Expand to a `lambda' expression that wraps around FN and BODY.
...
(fn &optional ARG)" t) (register-definition-prefixes "llama" '("##" "all-completions" "elisp-" "intern" "lisp--el-match-keyword@llama" "llama-")) (provide 'llama-autoloads)) "seq" ((seq-pkg seq-24 seq-25 seq seq-autoloads) (register-definition-prefixes "seq-24" '("seq")) (autoload 'seq-subseq "seq-25" "Return the sequence of elements of SEQUENCE from START to END.
END is exclusive.
...
(fn SEQUENCE)") (register-definition-prefixes "seq-25" '("seq-")) (provide 'seq-autoloads)) "magit-section" ((magit-section magit-section-autoloads) (autoload 'magit-add-section-hook "magit-section" "Add to the value of section hook HOOK the function FUNCTION.
...
(fn &optional (ENVVAR \"EDITOR\") PROCESS INTERACTIVE)" t) (autoload 'with-editor-export-git-editor "with-editor" "Like `with-editor-export-editor' but always set `$GIT_EDITOR'.

PROCESS is only intended for use by `eat-exec-hook'.  When invoked
interactively, INTERACTIVE is non-nil, which supresses the call to
\"clear\".

(fn &optional PROCESS INTERACTIVE)" t) (autoload 'with-editor-export-hg-editor "with-editor" "Like `with-editor-export-editor' but always set `$HG_EDITOR'.

PROCESS is only intended for use by `eat-exec-hook'.  When invoked
interactively, INTERACTIVE is non-nil, which supresses the call to
\"clear\".

(fn &optional PROCESS INTERACTIVE)" t) (defvar shell-command-with-editor-mode nil "Non-nil if Shell-Command-With-Editor mode is enabled.
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t) (register-definition-prefixes "with-editor" '("server-" "shell-command" "start-file-process" "with-editor")) (provide 'with-editor-autoloads)) "magit" ((magit-notes magit-reflog git-rebase magit-status magit-process magit-submodule magit-gitignore magit-core magit-patch magit-merge magit-worktree magit-git magit-sparse-checkout magit magit-reset magit-refs magit-repos magit-apply magit-log magit-subtree magit-clone magit-remote magit-wip magit-branch magit-fetch magit-autoloads magit-mode magit-dired magit-transient magit-diff magit-ediff magit-blame magit-pull magit-commit magit-base magit-push magit-extras \.dir-locals git-commit magit-sequence magit-files magit-bookmark magit-autorevert magit-tag magit-bundle magit-bisect magit-margin magit-stash) (put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode log-edit-mode git-commit-elisp-text-mode)))) (autoload 'git-commit-insert-changelog-gnu "git-commit" "Insert a GNU-style changelog at point while authorig a commit message.
...
\"--verbose\"." t) (autoload 'git-commit-insert-changelog-plain "git-commit" "Insert a simple changelog at point while authorig a commit message.
...
The modified definitions are extracted from the diff in the message
buffer, which is only available if \"git commit\" was invoked with
\"--verbose\"." t) (register-definition-prefixes "git-commit" '("git-commit-" "global-git-commit-mode")) (autoload 'git-rebase-current-line "git-rebase" "Parse current line into a `git-rebase-action' instance.
...
(fn BRANCH START-POINT)" t) (autoload 'magit-checkout-remote-ref "magit-branch" "Checkout reference REF from REMOTE.
...
(fn REMOTE REF)" t) (function-put 'magit-checkout-remote-ref 'interactive-only 'magit-call-git) (autoload 'magit-branch-spinout "magit-branch" "Create new branch from the unpushed commits.
...
(fn &optional UNSTAGED-ONLY)" t) (autoload 'magit-diff-paths "magit-diff" "Show changes between any two files on disk.
...
(fn REV &optional ARGS FILES MODULE)" t) (autoload 'magit-show-commit-removing-file "magit-diff" "Show the commit that removed FILE.

(fn FILE &optional ARGS)" t) (register-definition-prefixes "magit-diff" '("magit-")) (autoload 'magit-dired-jump "magit-dired" "Visit file at point using Dired.
...
(fn FILE)" t) (autoload 'magit-ediff "magit-ediff" nil t) (autoload 'magit-ediff-resolve-all "magit-ediff" nil t) (autoload 'magit-ediff-resolve-rest "magit-ediff" nil t) (autoload 'magit-ediff-stage "magit-ediff" nil t) (autoload 'magit-ediff-compare "magit-ediff" nil t) (autoload 'magit-ediff-dwim "magit-ediff" nil t) (autoload 'magit-ediff-show-staged "magit-ediff" nil t) (autoload 'magit-ediff-show-unstaged "magit-ediff" nil t) (autoload 'magit-ediff-show-working-tree "magit-ediff" nil t) (autoload 'magit-ediff-show-commit "magit-ediff" nil t) (autoload 'magit-ediff-show-stash "magit-ediff" nil t) (register-definition-prefixes "magit-ediff" '("magit-ediff-")) (autoload 'magit-git-mergetool "magit-extras" nil t) (autoload 'magit-run-git-gui-blame "magit-extras" "Run \"git gui blame\" on the given FILENAME and COMMIT.
Interactively run it for the current file and the `HEAD', with a
prefix or when the current file cannot be determined let the user
choose.  When the current buffer is visiting FILENAME instruct
blame to center around the line point is on.

(fn COMMIT FILENAME &optional LINENUM)" t) (autoload 'magit-run-git-gui "magit-extras" "Run \"git gui\" for the current git repository." t) (autoload 'magit-run-gitk "magit-extras" "Run `gitk' in the current repository." t) (autoload 'magit-run-gitk-branches "magit-extras" "Run `gitk --branches' in the current repository." t) (autoload 'magit-run-gitk-all "magit-extras" "Run `gitk --all' in the current repository." t) (autoload 'magit-project-status "magit-extras" "Run `magit-status' in the current project's root.
...
Also see `magit-project-dispatch'." t) (autoload 'magit-project-dispatch "magit-extras" "Run `magit-dispatch' in the current project's root.
...
Also see `magit-project-status'." t) (autoload 'magit-previous-line "magit-extras" "Like `previous-line' but with Magit-specific shift-selection.
...
(fn REV FILE)" t) (register-definition-prefixes "magit-files" '("magit-")) (register-definition-prefixes "magit-git" '("magit-")) (autoload 'magit-gitignore "magit-gitignore" nil t) (autoload 'magit-gitignore-in-topdir "magit-gitignore" nil t) (autoload 'magit-gitignore-in-subdir "magit-gitignore" nil t) (autoload 'magit-gitignore-in-gitdir "magit-gitignore" nil t) (autoload 'magit-gitignore-on-system "magit-gitignore" nil t) (autoload 'magit-skip-worktree "magit-gitignore" "Call \"git update-index --skip-worktree -- FILE\".
...
(fn &optional ARGS FILES)" t) (autoload 'magit-log-reflog "magit-log" "Show log for all objects mentioned in all reflogs.
...
(fn URL START END)" t) (register-definition-prefixes "magit-patch" '("magit-")) (register-definition-prefixes "magit-process" '("magit-")) (autoload 'magit-pull "magit-pull" nil t) (autoload 'magit-pull-from-pushremote "magit-pull" nil t) (autoload 'magit-pull-from-upstream "magit-pull" nil t) (autoload 'magit-pull-into-upstream "magit-pull" nil t) (autoload 'magit-pull-branch "magit-pull" "Pull from a branch read in the minibuffer.
...
(fn &optional DIRECTORY)" t) (autoload 'magit-status-setup-buffer "magit-status" "
...
(fn WORKTREE DIRECTORY)" t) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "dash" ((dash-autoloads dash) (autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
(fn &rest CMD)") (register-definition-prefixes "pfuture" '("pfuture-")) (provide 'pfuture-autoloads)) "lv" ((lv-autoloads lv) (register-definition-prefixes "lv" '("lv-")) (provide 'lv-autoloads)) "hydra" ((hydra-examples hydra hydra-autoloads hydra-ox) (autoload 'defhydra "hydra" "Create a Hydra - a family of functions with prefix NAME.
...
(fn PROMPT &optional INITIAL-INPUT)") (register-definition-prefixes "cfrs" '("cfrs-")) (provide 'cfrs-autoloads)) "treemacs" ((treemacs-customization treemacs-core-utils treemacs-tags treemacs-git-commit-diff-mode treemacs-async treemacs-autoloads treemacs-filewatch-mode treemacs-faces treemacs-scope treemacs-compatibility treemacs-visuals treemacs-file-management treemacs-bookmarks treemacs-workspaces treemacs-peek-mode treemacs-project-follow-mode treemacs-persistence treemacs-macros treemacs-mouse-interface treemacs-annotations treemacs treemacs-logging treemacs-follow-mode treemacs-mode treemacs-hydras treemacs-header-line treemacs-rendering treemacs-interface treemacs-dom treemacs-tag-follow-mode treemacs-extensions treemacs-icons treemacs-treelib treemacs-themes treemacs-fringe-indicator) (autoload 'treemacs-version "treemacs" "Return the `treemacs-version'." t) (autoload 'treemacs "treemacs" "Initialise or toggle treemacs.
...
(fn &rest ARG-OVERRIDES)") (register-definition-prefixes "nerd-icons" '("nerd-icons-")) (provide 'nerd-icons-autoloads)) "treemacs-nerd-icons" ((treemacs-nerd-icons treemacs-nerd-icons-autoloads) (autoload 'treemacs-nerd-icons-config "treemacs-nerd-icons" "Install treemacs configuration.") (register-definition-prefixes "treemacs-nerd-icons" '("treemacs-nerd-icons-")) (provide 'treemacs-nerd-icons-autoloads))))

#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version (16 "https://github.com/emacs-straight/org-mode.git") "use-package" nil "bind-key" nil "modus-themes" nil "vertico" nil "compat" nil "orderless" nil "marginalia" nil "corfu" nil "cape" nil "auctex" nil "pdf-tools" nil "tablist" nil "let-alist" nil "ebib" nil "parsebib" nil "magit" nil "cond-let" nil "llama" nil "magit-section" nil "seq" nil "transient" nil "with-editor" nil "treemacs" nil "cl-lib" nil "dash" nil "s" nil "ace-window" nil "avy" nil "pfuture" nil "hydra" nil "lv" nil "ht" nil "cfrs" nil "posframe" nil "treemacs-nerd-icons" nil "nerd-icons" nil)) melpa #s(hash-table test equal data (version 3 "use-package" nil "bind-key" nil "modus-themes" (modus-themes :type git :host github :repo "protesilaos/modus-themes") "vertico" (vertico :type git :files (:defaults "extensions/vertico-*.el" "vertico-pkg.el") :host github :repo "minad/vertico") "compat" nil "orderless" (orderless :type git :host github :repo "oantolin/orderless") "marginalia" (marginalia :type git :host github :repo "minad/marginalia") "corfu" (corfu :type git :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu") "cape" (cape :type git :host github :repo "minad/cape") "auctex" nil "pdf-tools" (pdf-tools :type git :files (:defaults "README" ("build" "Makefile") ("build" "server") "pdf-tools-pkg.el") :host github :repo "vedang/pdf-tools") "tablist" (tablist :type git :host github :repo "emacsorphanage/tablist") "let-alist" nil "ebib" (ebib :type git :host github :repo "joostkremers/ebib") "parsebib" (parsebib :type git :host github :repo "joostkremers/parsebib") "magit" (magit :type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("githooks" "githooks/*") ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit") "cond-let" (cond-let :type git :host github :repo "tarsius/cond-let") "llama" (llama :type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama") "magit-section" (magit-section :type git :files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :host github :repo "magit/magit") "seq" nil "transient" (transient :type git :host github :repo "magit/transient") "with-editor" (with-editor :type git :host github :repo "magit/with-editor") "treemacs" (treemacs :type git :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs") "cl-lib" nil "dash" (dash :type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "s" (s :type git :host github :repo "magnars/s.el") "ace-window" (ace-window :type git :host github :repo "abo-abo/ace-window") "avy" (avy :type git :host github :repo "abo-abo/avy") "pfuture" (pfuture :type git :host github :repo "Alexander-Miller/pfuture") "hydra" (hydra :type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "lv" (lv :type git :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "ht" (ht :type git :host github :repo "Wilfred/ht.el") "cfrs" (cfrs :type git :host github :repo "Alexander-Miller/cfrs") "posframe" (posframe :type git :host github :repo "tumashu/posframe") "treemacs-nerd-icons" (treemacs-nerd-icons :type git :host github :repo "rainstormstudio/treemacs-nerd-icons") "nerd-icons" (nerd-icons :type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el"))) gnu-elpa-mirror #s(hash-table test equal data (version 3 "use-package" (use-package :type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git"))) "bind-key" (bind-key :type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git"))) "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "auctex" (auctex :type git :host github :repo "emacs-straight/auctex" :files ("*" (:exclude ".git"))) "let-alist" (let-alist :type git :host github :repo "emacs-straight/let-alist" :files ("*" (:exclude ".git"))) "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git"))) "cl-lib" nil)) nongnu-elpa #s(hash-table test equal data (version (5 "https://github.com/emacsmirror/nongnu_elpa.git") "cl-lib" nil)) el-get #s(hash-table test equal data (version 2 "cl-lib" nil)) emacsmirror-mirror #s(hash-table test equal data (version 2 "cl-lib" nil))))

("nerd-icons" "treemacs-nerd-icons" "posframe" "cfrs" "ht" "lv" "hydra" "pfuture" "avy" "ace-window" "s" "dash" "cl-lib" "treemacs" "with-editor" "transient" "seq" "magit-section" "llama" "cond-let" "magit" "parsebib" "ebib" "let-alist" "tablist" "pdf-tools" "auctex" "cape" "corfu" "marginalia" "orderless" "compat" "vertico" "modus-themes" "bind-key" "use-package" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa" "emacs" "straight")
